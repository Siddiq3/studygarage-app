...
const Sa26dataka = ({ navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('https://siddiq3.github.io/Api/6thsa2ka.json');
    ...
    const handleTitlePress = (url) => {
        ...
        navigation.navigate('Sa26Pageka', { url });
    };
