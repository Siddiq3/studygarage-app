        ...
        <View style={styles.container}>
            ...
            <View style={styles.innerContainer}>
                ...
                <View style={styles.buttonRow}>
                    ...
                    {renderButton('TB', () => navigation.navigate('6thclass tb'), 'tb6')}
                    {renderButton('Imp', () => navigation.navigate('6thclass imp'), 'imp6')}
                    {renderButton('FA1', () => navigation.navigate('6thclass fa1'), 'fa16')}
                </View>
                {/* Third row */}
                <View style={styles.buttonRow}>
                    {renderButton('FA2', () => navigation.navigate('6thclass fa2'), 'fa26')}
                    {renderButton('SA1', () => navigation.navigate('6thclass sa1'), 'sa16')}
                    {renderButton('FA3', () => navigation.navigate('6thclass fa3'), 'fa36')}
                </View>
