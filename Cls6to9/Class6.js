        ...
        <View style={styles.container} horizontal={false}>
            <ScrollView>
                ...
                <Card style={{ padding: 10, margin: 15 }}>
                    ...
                    >
                        {isLoading ? <Text style={{ fontSize: 16, fontWeight: '500', }}>Loading...</Text> : questions && (<Text style={{ textAlign: 'center', fontSize: 20, textAlignVertical: 'center', }}>{decodeURIComponent(questions.study6)}</Text>)}
                    </TouchableOpacity>
                </Card>
