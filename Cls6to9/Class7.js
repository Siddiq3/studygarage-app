...
const Class7 = ({ navigation }) => {
  ...
  const checkButtonStatus = async () => {
    try {
      const lastButtonClickTime = await AsyncStorage.getItem('lastButtonClickTime7');
  ...
  const buttons = [
    { id: 'tb7', label: decodeText(questions?.tb7), onPress: () => handleNavigate('7thclass tb') },
    { id: 'imp7', label: decodeText(questions?.imp7), onPress: () => handleNavigate('7thclass imp') },
    { id: 'fa17', label: decodeText(questions?.fa17), onPress: () => handleNavigate('7thclass fa1') },
    { id: 'fa27', label: decodeText(questions?.fa27), onPress: () => handleNavigate('7thclass fa2') },
    { id: 'sa17', label: decodeText(questions?.sa17), onPress: () => handleNavigate('7thclass sa1') },
    { id: 'fa37', label: decodeText(questions?.fa37), onPress: () => handleNavigate('7thclass fa3') },
