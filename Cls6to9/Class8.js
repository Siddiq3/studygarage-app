...
const Class8 = ({ navigation }) => {
    ...
    const checkButtonStatus = async () => {
        try {
            const lastButtonClickTime8 = await AsyncStorage.getItem("lastButtonClickTime8");
            if (lastButtonClickTime8) {
                const timeDifference = differenceInMilliseconds(new Date(), new Date(lastButtonClickTime8));
