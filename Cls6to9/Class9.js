...
const Class9 = ({ navigation }) => {
    ...
    const checkButtonStatus = async () => {
        try {
            const lastButtonClickTime9 = await AsyncStorage.getItem("lastButtonClickTime9");
            if (lastButtonClickTime9) {
                const timeDifference = differenceInMilliseconds(new Date(), new Date(lastButtonClickTime9));
