...
const Class9ka = ({ navigation }) => {
    ...
    const checkButtonStatus = async () => {
        try {
            const lastButtonClickTime9ka = await AsyncStorage.getItem("lastButtonClickTime9ka");
            if (lastButtonClickTime9ka) {
                const timeDifference = differenceInMilliseconds(new Date(), new Date(lastButtonClickTime9ka));
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.innerContainer}>
                <Text style={styles.textAboveButtons}>Karnataka 9thclass</Text>
                        ...
                        {isLoading ? (
                            ...
                            <>
                                <Text style={styles.buttonText}>
                                    {decodeURIComponent(questions?.t9ka || '')} Quiz
                                </Text>
                                <Text style={styles.subButtonText}>
                                    Q. {decodeURIComponent(questions?.q9ka || '')}?
                                </Text>
                            </>
                        )}
