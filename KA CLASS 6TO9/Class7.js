...
const Class7ka = ({ navigation }) => {
    ...
    const checkButtonStatus = async () => {
        try {
            const lastButtonClickTime7ka = await AsyncStorage.getItem("lastButtonClickTime7ka");
            if (lastButtonClickTime7ka) {
                const timeDifference = differenceInMilliseconds(new Date(), new Date(lastButtonClickTime7ka));
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.innerContainer}>
                <Text style={styles.textAboveButtons}>Karnataka 7thclass</Text>
                        ...
                        {isLoading ? (
                            ...
                            <>
                                <Text style={styles.buttonText}>
                                    {decodeURIComponent(questions?.t7ka || '')} Quiz
                                </Text>
                                <Text style={styles.subButtonText}>
                                    Q. {decodeURIComponent(questions?.q7ka || '')}?
                                </Text>
                            </>
                        )}
