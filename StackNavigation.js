...
import SuccessScreen from "./src/features/quiz/SuccessScreen";
import QuizZoneScreen from "./src/features/quiz/QuizZoneScreen";
...
import WalletActivityScreen from "./src/features/rewards/WalletActivityScreen";
import CoinHistoryScreen from "./src/features/rewards/CoinHistoryScreen";
import GoogleVoucherScreen from "./src/features/rewards/GoogleVoucherScreen";
import FlipkartVoucherScreen from "./src/features/rewards/FlipkartVoucherScreen";
import AmazonVoucherScreen from "./src/features/rewards/AmazonVoucherScreen";
import UPIVoucherScreen from "./src/features/rewards/UPIVoucherScreen";
import RedeemFormScreen from "./src/features/rewards/RedeemFormScreen";
...
import WelcomeRewardScreen from "./src/features/onboardingReward/WelcomeRewardScreen";
import StreakDetailsScreen from "./src/features/home/StreakDetailsScreen";
// Referral feature temporarily disabled.
// import ReferralScreen from "./src/screens/Referral/ReferralScreen";
// import ApplyReferralScreen from "./src/screens/Referral/ApplyReferralScreen";
// import ClaimRewardScreen from "./src/screens/Referral/ClaimRewardScreen";
...
const MainStackNavigator1 = () => {
  ...
  useEffect(() => {
    ...
    const resolveInitialRoute = async () => {
      try {
        const [userName, avatar, stateBoard, classValue, pendingWelcome] =
          await Promise.all([
            AsyncStorage.getItem("userName"),
            AsyncStorage.getItem("avatar"),
            AsyncStorage.getItem("stateBoard"),
            AsyncStorage.getItem("classValue"),
            localStore.getBool(localStore.keys.pendingWelcome, false),
          ]);

        if (!mounted) return;

        const hasCompleteProfile = Boolean(
          userName && avatar && stateBoard && classValue
        );
        ...
        if (hasCompleteProfile) {
          ...
          setInitialRouteName(pendingWelcome ? "WelcomeReward" : "SecondPage");
        } else {
          setBootParams(null);
  ...
  if (!routeResolved || !initialRouteName) {
    return (
      <View
        style={{
          flex: 1,
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        ...
        initialParams={bootParams || undefined}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="StreakDetailsScreen"
      ...
      />
      <Stack.Screen
        name="WalletActivityScreen"
        component={WalletActivityScreen}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="CoinHistoryScreen"
        component={CoinHistoryScreen}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="GoogleVoucherScreen"
        component={GoogleVoucherScreen}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="FlipkartVoucherScreen"
        component={FlipkartVoucherScreen}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="AmazonVoucherScreen"
        component={AmazonVoucherScreen}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="UPIVoucherScreen"
        component={UPIVoucherScreen}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="RedeemFormScreen"
        component={RedeemFormScreen}
        options={{ headerShown: false }}
      />
      {/* Referral feature temporarily disabled. */}
      {/* <Stack.Screen
      ...
      <Stack.Screen
        name="interimp1"
        component={Inter1stimpdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Inter1stimpPage"
        component={Inter1stimppdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="interprev1"
        component={Inter1stpqpdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Inter1stpqpPage"
        component={Inter1stpqppdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="year1m"
        component={Inter1stmdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Inter1stmPage"
        component={Inter1stmpdf}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="interimp2"
        component={Inter2ndimpdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Inter2ndimpPage"
        component={Inter2ndimppdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="interprev2"
        component={Inter2ndpqpdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Inter2ndpqpPage"
        component={Inter2ndpqppdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="year2m"
        component={Inter2ndmdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Inter2ndmPage"
        component={Inter2ndmpdf}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="Physicstm ImpTs"
        component={Pttsimp}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Physicsem ImpTs"
        component={Petsimp}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Biologytm ImpTs"
        component={Nttsimp}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Biologyem ImpTs"
        component={Netsimp}
        options={{ headerShown: false }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        name="6thToday Answer"
        component={qans6}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="7thToday Answer"
        component={qans7}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="8thToday Answer"
        component={qans8}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="11thToday Answer"
        component={qans11}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="12thToday Answer"
        component={qans12}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="maths em textbook"
        component={Mathset}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="maths tm textbook"
        component={Mathtt}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="physics em textbook"
        component={Phyet}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="physics tm textbook"
        component={Phytt}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="biology em textbook"
        component={Nset}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="biology tm textbook"
        component={Nstt}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="social em textbook"
        component={Societ}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="social tm textbook"
        component={Socitt}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="phyics material"
        component={Materialphy}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="ib"
        component={Materialbio}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="maths Material"
        component={Materialmaths}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="telugu testpapersTS"
        component={Teltpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="hindi testpapersTS"
        component={Hintpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="english testpapersTS"
        component={Engtpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="maths em testpapersTS"
        component={Matetpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="maths tm testpapersTS"
        component={Matttpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="physics em testpapersTS"
        component={Phyetpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="physics tm testpapersTS"
        component={Phyttpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="ns em testpapersTS"
        component={Netpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="ns tm testpapersTS"
        component={Nttpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="social em testpapersTS"
        component={Socetpts}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="social tm testpapersTS"
        component={Socttpts}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="socialem ts tp1"
        component={Ssetpts1}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="socialem ts tp2"
        component={Ssetpts2}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="socialem ts tp3"
        component={Ssetpts3}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="socialem ts tp4"
        component={Ssetpts4}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="socialtm ts tp1"
        component={Ssttpts1}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="socialtm ts tp2"
        component={Ssttpts2}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="socialtm ts tp3"
        component={Ssttpts3}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="socialtm ts tp4"
        component={Ssttpts4}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="BiologyTm 2022p"
        component={Nstp2}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="BiologyEM 2022p"
        component={Nsep2}
        options={{ headerShown: false }}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name="PhysicsEm 2022p"
        component={Phyep2}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PhysicsTm 2022p"
        component={Phytp2}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="BiologyEM 2019p"
        component={Nsep4}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SocialEm 2019p1"
        component={Socep4}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PhysicsEm 2019p"
        component={Phyep4}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="BiologyEM 2018p"
        component={Nsep6}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SocialEm 2018p1"
        component={Socep6}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PhysicsEm 2018p"
        component={Phyp6}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="BiologyEM 2017p"
        component={Nsep8}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SocialEm 2017p1"
        component={Socep8}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PhysicsEm 2017p"
        component={Phyp8}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="BiologyEM 2016p"
        component={Nsep11}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SocialEm 2016p1"
        component={Socep11}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PhysicsEm 2016p"
        component={Phyp11}
        options={{ headerShown: false }}
      />
      ...
      />
      <Stack.Screen
        name="BiologyEM 2015p"
        component={Nsep13}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SocialEm 2015p1"
        component={Socep13}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PhysicsEm 2015p"
        component={Phyp13}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="apblueprint1"
        component={Blueprintdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="UrlPage"
        component={Blueprintpdf}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="Telugu Imp"
        component={Impteldata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Hindi Imp"
        component={Imphindata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="English Imp"
        component={Impengdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Mathstm Imp"
      ...
      <Stack.Screen
        name="modelpapers"
        component={Modelpaperdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="ModelpaperPage"
        component={Modelpaperpdf}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="prefinal1"
        component={Prefinaldata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PrefinalPage"
        component={Prefinalpdf}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="ssc2023"
        component={Public2023data}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Public2023Page"
        component={Pub2023pdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="map"
      ...
      <Stack.Screen
        name="weeklytest1"
        component={Weeklytestdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="WeeklytestPage"
        component={Weeklytestpdf}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="dailytest"
        component={Dailytestdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="DailytestPage"
        component={Dailytestpdf}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="grandtest"
        component={Grandtestdata}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="GrandtestPage"
        component={Grandtestpdf}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="Mcasem1dataPage"
        component={Mcasem1Pdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Mcasem2dataPage"
        component={Mcasem2Pdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Mcasem3dataPage"
        component={Mcasem3Pdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Mcasem4dataPage"
        component={Mcasem4Pdf}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="Mbasem1dataPage"
        component={Mbasem1Pdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Mbasem2dataPage"
        component={Mbasem2Pdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Mbasem3dataPage"
        component={Mbasem3Pdf}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Mbasem4dataPage"
        component={Mbasem4Pdf}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="modelpaperska"
        component={Modelpaperdataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="ModelpaperPageka"
        component={Modelpaperpdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="prefinalka"
        component={Prefinaldataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="PrefinalPageka"
        component={Prefinalpdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="ssc2023ka"
        component={Public2023dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="Public2023Pageka"
        component={Pub2023pdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="kablueprint1"
        component={Blueprintdataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="blueprintka"
        component={Blueprintpdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="solutionka"
        component={Solutiondataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="solutionPageka"
        component={Solutionpdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="Importentka"
        component={Impquestiondataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="imppqpPageka"
        component={Impquestionspdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="textbookska"
        component={Textbookka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="textbooksPageka"
        component={Textbookpdfka}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="kanada ka"
        component={Kanadapqpdataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="KanPqpPageka"
        component={Kanpqppdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="hindi ka"
        component={Hinpqpdataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="HinPqpPageka"
        component={Hinpqppdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="english ka"
        component={Engpqpdataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="EngPqpPageka"
        component={Enfpqppdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="maths ka"
        component={Matpqpdataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="MatPqpPageka"
        component={Matpqppdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="biology ka"
        component={Scipqpdataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SciPqpPageka"
        component={Scipqppdfka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="social ka"
        component={Socpqpdataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="SocPqpPageka"
        component={Socpqppdfka}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="6thclass fa1ka"
        component={Fa16dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="6thclass fa2ka"
        component={Fa26dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="6thclass fa3ka"
        component={Fa36dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="6thclass fa4ka"
        component={Fa46dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="6thclass sa1ka"
        component={Sa16dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="6thclass sa2ka"
        component={Sa26dataka}
        options={{ headerShown: false }}
      />

      <Stack.Screen
        name="6thclass impka"
        component={Imp6dataka}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="7thclass fa1ka"
        component={Fa17dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="7thclass fa2ka"
        component={Fa27dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="7thclass fa3ka"
        component={Fa37dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="7thclass fa4ka"
        component={Fa47dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="7thclass sa1ka"
        component={Sa17dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="7thclass sa2ka"
        component={Sa27dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="7thclass impka"
        component={Imp7dataka}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="8thclass fa1ka"
        component={Fa18dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="8thclass fa2ka"
        component={Fa28dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="8thclass fa3ka"
        component={Fa38dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="8thclass fa4ka"
        component={Fa48dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="8thclass sa1ka"
        component={Sa18dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="8thclass sa2ka"
        component={Sa28dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="8thclass impka"
        component={Imp8dataka}
        options={{ headerShown: false }}
      />
      ...
      <Stack.Screen
        name="9thclass fa1ka"
        component={Fa19dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="9thclass fa2ka"
        component={Fa29dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="9thclass fa3ka"
        component={Fa39dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="9thclass fa4ka"
        component={Fa49dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="9thclass sa1ka"
        component={Sa19dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="9thclass sa2ka"
        component={Sa29dataka}
        options={{ headerShown: false }}
      />
      <Stack.Screen
        name="9thclass impka"
        component={Imp9dataka}
        options={{ headerShown: false }}
      />
