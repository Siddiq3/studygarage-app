            ...
            <ScrollView>
                ...
                <Card style={{ padding: 6, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('mathsem tp1')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('mathsem tp1') }
                        }}
                    >
                ...
                <Card style={{ padding: 6, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('mathsem tp2')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('mathsem tp2') }
                        }}
                    >
                ...
                <Card style={{ padding: 6, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('mathsem tp3')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('mathsem tp3') }
                        }}
                    >
                ...
                <Card style={{ padding: 6, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('mathsem tp4')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('mathsem tp4') }
                        }}
                    >
