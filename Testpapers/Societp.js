            ...
            <ScrollView>
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialem tp1')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialem tp1') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialem tp2')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialem tp2') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialem tp3')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialem tp3') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialem tp4')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialem tp4') }
                        }}
                    >
