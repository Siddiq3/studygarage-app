            ...
            <ScrollView>
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('phytm tp1')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('phytm tp1') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('phytm tp2')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('phytm tp2') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('phytm tp3')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('phytm tp3') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('phytm tp4')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('phytm tp4') }
                        }}
                    >
