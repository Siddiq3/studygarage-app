            ...
            <ScrollView>
                ...
                <Card style={{ padding: 20, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('hindi tp1')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('hindi tp1') }
                        }}
                    >
                ...
                <Card style={{ padding: 20, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('hindi tp2')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('hindi tp2') }
                        }}
                    >
                ...
                <Card style={{ padding: 20, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('hindi tp3')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('hindi tp3') }
                        }}
                    >
                ...
                <Card style={{ padding: 20, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('hindi tp4')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('hindi tp4') }
                        }}
                    >
