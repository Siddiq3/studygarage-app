...
const DailyResult = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableWithoutFeedback onPress={() => navigation.navigate('Today Answer')} style={styles.button}
                onPressOut={() => {
                    if (interstitialLoaded) {

                        interstitial.show();
                    } else { navigation.navigate('Today Answer') }
                }}
            >
