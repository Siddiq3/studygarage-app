...
const adUnitId1 = __DEV__ ? TestIds.GAM_BANNER : 'ca-app-pub-2818388282601075/9316917005';
...
const qans9 = ({ navigation }) => {
    ...
    const getQuiz = async () => {
        setIsLoading(true)
        const url = 'https://siddiq3.github.io/Api/Quizapi9.json';
