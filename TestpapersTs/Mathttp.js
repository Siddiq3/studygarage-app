...
const Matttpts = ({ navigation }) => {
    ...
    const testPapers = [
        { id: 1, name: 'TestPaper-1', route: 'mathstm ts tp1' },
        { id: 2, name: 'TestPaper-2', route: 'mathstm ts tp2' },
        { id: 3, name: 'TestPaper-3', route: 'mathstm ts tp3' },
        { id: 4, name: 'TestPaper-4', route: 'mathstm ts tp4' },
    ];
