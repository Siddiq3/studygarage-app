            ...
            <ScrollView>
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialtm ts tp1')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialtm ts tp1') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialtm ts tp2')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialtm ts tp2') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialtm ts tp3')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialtm ts tp3') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialtm ts tp4')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialtm ts tp4') }
                        }}
                    >
