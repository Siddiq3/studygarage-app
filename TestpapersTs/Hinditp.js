            ...
            <ScrollView>
                ...
                <Card style={{ padding: 20, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('hindi ts tp1')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('hindi ts tp1') }
                        }}
                    >
                ...
                <Card style={{ padding: 20, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('hindi ts tp2')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('hindi ts tp2') }
                        }}
                    >
                ...
                <Card style={{ padding: 20, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('hindi ts tp3')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('hindi ts tp3') }
                        }}
                    >
                ...
                <Card style={{ padding: 20, margin: 20 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('hindi ts tp4')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('hindi ts tp4') }
                        }}
                    >
