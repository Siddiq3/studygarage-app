            ...
            <ScrollView>
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialem ts tp1')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialem ts tp1') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialem ts tp2')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialem ts tp2') }
                        }}
                    >
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialem ts tp3')} onPressOut={() => {
                            if (interstitialLoaded) {
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() =>
                        navigation.navigate('socialem ts tp4')} onPressOut={() => {
                            if (interstitialLoaded) {

                                interstitial.show();
                            } else { navigation.navigate('socialem ts tp4') }
                        }}
                    >
