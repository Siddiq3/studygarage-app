        ...
        <View style={styles.container}>
            <ScrollView>
                ...
                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() => navigation.navigate('phytm ts tp1')}>
                        <Text style={{ fontSize: 20 }}>TestPaper-1</Text>
                    </TouchableWithoutFeedback>
                </Card>

                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() => navigation.navigate('phytm ts tp2')}>
                        <Text style={{ fontSize: 20 }}>TestPaper-2</Text>
                    </TouchableWithoutFeedback>
                </Card>

                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() => navigation.navigate('phytm ts tp3')}>
                        <Text style={{ fontSize: 20 }}>TestPaper-3</Text>
                    </TouchableWithoutFeedback>
                </Card>

                <Card style={{ padding: 25, margin: 15 }}>
                    <TouchableWithoutFeedback onPress={() => navigation.navigate('phytm ts tp4')}>
