...
const adUnitId = __DEV__ ? TestIds.INTERSTITIAL : 'ca-app-pub-3251781230941397/9492220282';
...
const Imphindata = ({ navigation }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('https://siddiq3.github.io/Api/10thimphin.json');
    ...
    const handleTitlePress = (url) => {
        ...
        navigation.navigate('ImphinPage', { url });
    };
